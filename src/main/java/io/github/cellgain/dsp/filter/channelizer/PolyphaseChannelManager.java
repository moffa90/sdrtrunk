 ...
 * ****************************************************************************
 */
package io.github.cellgain.dsp.filter.channelizer;

import io.github.cellgain.controller.channel.event.ChannelStopProcessingRequest;
import io.github.cellgain.dsp.filter.channelizer.output.IPolyphaseChannelOutputProcessor;
import io.github.cellgain.dsp.filter.channelizer.output.OneChannelOutputProcessor;
import io.github.cellgain.dsp.filter.channelizer.output.TwoChannelOutputProcessor;
import io.github.cellgain.source.tuner.channel.TunerChannel;
import io.github.cellgain.source.tuner.channel.TunerChannelSource;
import io.github.cellgain.buffer.INativeBuffer;
import io.github.cellgain.buffer.INativeBufferProvider;
import io.github.cellgain.buffer.NativeBufferPoisonPill;
...
import io.github.cellgain.sample.complex.InterleavedComplexSamples;
...
import io.github.cellgain.source.tuner.TunerController;
...
public class PolyphaseChannelManager implements ISourceEventProcessor
{
    ...
    public PolyphaseChannelManager(INativeBufferProvider nativeBufferProvider, long frequency, double sampleRate)
    {
        ...
        mBufferDispatcher = new Dispatcher(500, "sdrapp polyphase buffer processor",
