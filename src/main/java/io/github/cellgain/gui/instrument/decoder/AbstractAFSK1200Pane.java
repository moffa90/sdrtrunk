...
import io.github.cellgain.gui.instrument.chart.AFSK1200SampleBufferChart;
import io.github.cellgain.gui.instrument.chart.AFSK1200ZeroCrossingErrorDetectorChart;
import io.github.cellgain.gui.instrument.chart.DecodedSymbolChart;
import io.github.cellgain.gui.instrument.chart.IInstrumentedAFSK1200Decoder;
import io.github.cellgain.gui.instrument.chart.RealSampleLineChart;
...
public abstract class AbstractAFSK1200Pane extends RealDecoderPane
{
    ...
    private void init()
    {
        ...
        setVgrow(getSampleChartBox(), Priority.ALWAYS);
        setVgrow(getSymbolDecoderBox(), Priority.ALWAYS);
