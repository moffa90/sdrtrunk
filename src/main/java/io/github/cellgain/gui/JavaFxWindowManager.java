...
import io.github.cellgain.controller.channel.map.ChannelRange;
import io.github.cellgain.eventbus.MyEventBus;
import io.github.cellgain.gui.icon.IconManager;
import io.github.cellgain.gui.icon.ViewIconManagerRequest;
import io.github.cellgain.gui.playlist.PlaylistEditor;
import io.github.cellgain.gui.playlist.PlaylistEditorRequest;
import io.github.cellgain.gui.playlist.ViewPlaylistRequest;
import io.github.cellgain.gui.playlist.channelMap.ChannelMapEditor;
import io.github.cellgain.gui.playlist.channelMap.ViewChannelMapEditorRequest;
import io.github.cellgain.gui.preference.PreferenceEditorType;
import io.github.cellgain.gui.preference.UserPreferencesEditor;
...
import io.github.cellgain.jmbe.JmbeEditor;
import io.github.cellgain.jmbe.JmbeEditorRequest;
...
public class JavaFxWindowManager extends Application
{
    ...
    public Stage getIconManagerStage()
    {
        if(mIconManagerStage == null)
        {
            ...
            mIconManagerStage.setTitle("sdrapp - Icon Manager");
    ...
    public Stage getJmbeEditorStage()
    {
        if(mJmbeEditorStage == null)
        {
            ...
            mJmbeEditorStage.setTitle("sdrapp - JMBE Library Updater");
    ...
    private Stage getPlaylistStage()
    {
        if(mPlaylistStage == null)
        {
            ...
            mPlaylistStage.setTitle("sdrapp - Playlist Editor");
    ...
    private Stage getUserPreferencesStage()
    {
        if(mUserPreferencesStage == null)
        {
            ...
            mUserPreferencesStage.setTitle("sdrapp - User Preferences");
    ...
    private Stage getChannelMapStage()
    {
        if(mChannelMapStage == null)
        {
            ...
            mChannelMapStage.setTitle("sdrapp - Channel Map Editor");
