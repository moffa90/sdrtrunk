...
package io.github.cellgain.gui.preference.mp3;
...
public class MP3PreferenceEditor extends HBox
{
    ...
    private GridPane getEditorPane()
    {
        if(mEditorPane == null)
        {
            ...
            Label notice = new Label("Note: sdrapp default 8 kHz audio rate is resampled to input sample rate before MP3 encoding");
