...
public class CalibrationDialog extends Dialog
{
    ...
    public CalibrationDialog(UserPreferences userPreferences)
    {
        ...
        Label instructionsLabel = new Label("The sdrapp application can run more efficiently by using Vector or Single " +
                "Instruction Multiple Data (SIMD) CPU operations.  sdrapp must calibrate your CPU in order " +
                "to determine the best implementation.\n\n" +
                "Calibration takes a few minutes to complete.\n\n" +
                "If you click 'Cancel', you will be prompted next time you run sdrapp, or you can open the " +
