...
package io.github.cellgain.gui.preference.calibration;
...
import io.github.cellgain.log.TextAreaLogAppender;
...
public class VectorCalibrationPreferenceEditor extends HBox
{
    ...
    private ToggleSwitch getVectorEnabledToggleSwitch()
    {
        if(mVectorEnabled == null)
        {
            ...
            mVectorEnabled.setTooltip(new Tooltip("Allow sdrapp to use optimized vector operations when supported by your CPU"));
