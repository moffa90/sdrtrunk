...
import io.github.cellgain.alias.action.beep.BeepAction;
import io.github.cellgain.alias.action.clip.ClipAction;
import io.github.cellgain.alias.action.script.ScriptAction;
import io.github.cellgain.alias.id.broadcast.BroadcastChannel;
import io.github.cellgain.alias.id.esn.Esn;
import io.github.cellgain.alias.id.lojack.LoJackFunctionAndID;
import io.github.cellgain.alias.id.radio.Radio;
import io.github.cellgain.alias.id.radio.RadioFormatter;
import io.github.cellgain.alias.id.radio.RadioRange;
import io.github.cellgain.alias.id.status.UnitStatusID;
import io.github.cellgain.alias.id.status.UserStatusID;
import io.github.cellgain.alias.id.talkgroup.Talkgroup;
import io.github.cellgain.alias.id.talkgroup.TalkgroupFormatter;
import io.github.cellgain.alias.id.talkgroup.TalkgroupRange;
import io.github.cellgain.alias.id.tone.TonesID;
import io.github.cellgain.gui.playlist.alias.action.ActionEditor;
import io.github.cellgain.gui.playlist.alias.action.ActionEditorFactory;
import io.github.cellgain.gui.playlist.alias.action.EmptyActionEditor;
import io.github.cellgain.gui.playlist.alias.identifier.EmptyIdentifierEditor;
import io.github.cellgain.gui.playlist.alias.identifier.IdentifierEditor;
import io.github.cellgain.gui.playlist.alias.identifier.IdentifierEditorFactory;
import io.github.cellgain.alias.Alias;
import io.github.cellgain.alias.AliasFactory;
import io.github.cellgain.alias.AliasList;
import io.github.cellgain.alias.action.AliasAction;
import io.github.cellgain.alias.action.AliasActionType;
import io.github.cellgain.alias.id.AliasID;
import io.github.cellgain.alias.id.AliasIDType;
import io.github.cellgain.audio.broadcast.ConfiguredBroadcast;
import io.github.cellgain.eventbus.MyEventBus;
import io.github.cellgain.gui.playlist.Editor;
import io.github.cellgain.icon.Icon;
import io.github.cellgain.playlist.PlaylistManager;
import io.github.cellgain.preference.PreferenceType;
import io.github.cellgain.preference.UserPreferences;
import io.github.cellgain.preference.identifier.IntegerFormat;
...
public class AliasItemEditor extends Editor<Alias>
{
    ...
    public void setItem(Alias alias)
    {
        ...
        if(alias != null)
        {
            ...
            boolean canMonitor = (monitorPriority != io.github.cellgain.alias.id.priority.Priority.DO_NOT_MONITOR);
            getMonitorAudioToggleSwitch().setSelected(canMonitor);

            if(canMonitor && monitorPriority != io.github.cellgain.alias.id.priority.Priority.DEFAULT_PRIORITY)
            {
        ...
        if(modifiedProperty().get())
        {
            ...
            if(alias != null)
            {
                ...
                if(canMonitor)
                {
                    if(priority == null)
                    {
                        priority = io.github.cellgain.alias.id.priority.Priority.DEFAULT_PRIORITY;
                    }
                ...
                {
                    alias.setCallPriority(io.github.cellgain.alias.id.priority.Priority.DO_NOT_MONITOR);
                }
    ...
    private ComboBox<Integer> getMonitorPriorityComboBox()
    {
        if(mMonitorPriorityComboBox == null)
        {
            ...
            for(int x = io.github.cellgain.alias.id.priority.Priority.MIN_PRIORITY;
                x < io.github.cellgain.alias.id.priority.Priority.MAX_PRIORITY; x++)
            {
