...
public class SystemTalkgroupSelectionEditor extends GridPane
{
    ...
    public void createAlias(Talkgroup talkgroup)
    {
        ...
        {
            int priority = io.github.cellgain.alias.id.priority.Priority.DO_NOT_MONITOR;
            alias.addAliasID(new io.github.cellgain.alias.id.priority.Priority(priority));
        }
    ...
    private void updateAlias(Alias alias)
    {
        ...
        if(alias != null)
        {
            ...
            {
                if(aliasID instanceof io.github.cellgain.alias.id.talkgroup.Talkgroup)
                {
                    int value = ((io.github.cellgain.alias.id.talkgroup.Talkgroup)aliasID).getValue();
