...
public class ChangeChannelTimeoutEvent extends DecoderStateEvent
{
     ...
     */
    public ChangeChannelTimeoutEvent(Object source, Channel.ChannelType channelType, long timeout, int timeslot)
    {
     ...
     */
    public ChangeChannelTimeoutEvent(Object source, Channel.ChannelType channelType, long timeout)
    {
