...
package io.github.cellgain.audio.broadcast.broadcastify;

import com.google.common.net.HttpHeaders;
import io.github.cellgain.alias.AliasModel;
import io.github.cellgain.audio.broadcast.AbstractAudioBroadcaster;
import io.github.cellgain.audio.broadcast.AudioRecording;
import io.github.cellgain.audio.broadcast.BroadcastEvent;
...
import io.github.cellgain.gui.playlist.radioreference.RadioReferenceDecoder;
...
import io.github.cellgain.identifier.configuration.ConfigurationLongIdentifier;
            ...
            if(isValid(audioRecording) && audioRecording.getRecordingLength() > 0)
            {
                ...
                try
                {
                    HttpRequest request = HttpRequest.newBuilder()
                        ...
                        .header(HttpHeaders.USER_AGENT, "sdrapp")
