 ...
 *
 */
package io.github.cellgain.module.decode.p25.phase1.message.pdu;

import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.AMBTCHeader;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.block.ConfirmedDataBlock;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.block.DataBlock;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.block.UnconfirmedDataBlock;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.packet.PacketHeader;
...
import io.github.cellgain.module.decode.p25.phase1.message.pdu.response.ResponseMessage;
...
import io.github.cellgain.bits.BinaryMessage;
...
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.isp.AMBTCAuthenticationQuery;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.isp.AMBTCAuthenticationResponse;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.isp.AMBTCCallAlertRequest;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.isp.AMBTCGroupAffiliationRequest;
...
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.isp.AMBTCRoamingAddressRequest;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.isp.AMBTCStatusQueryRequest;
...
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.osp.AMBTCAdjacentStatusBroadcast;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.osp.AMBTCCallAlert;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.osp.AMBTCGroupAffiliationQuery;
...
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.osp.AMBTCNetworkStatusBroadcast;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.osp.AMBTCProtectionParameterBroadcast;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.osp.AMBTCRFSSStatusBroadcast;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.osp.AMBTCRoamingAddressResponse;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.osp.AMBTCRoamingAddressUpdate;
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.osp.AMBTCStatusQuery;
...
import io.github.cellgain.module.decode.p25.phase1.message.pdu.ambtc.osp.AMBTCUnitToUnitAnswerRequest;
...
import io.github.cellgain.module.decode.p25.reference.PDUFormat;
...
public class PDUMessageFactory
{
    ...
    {
        Opcode opcode = OSP_UNKNOWN;

        if(pduSequence.hasDataBlock(0))
        {
            opcode = fromValue(pduSequence.getDataBlock(0).getMessage().getInt(BLOCK_0_UMBTC_OPCODE),
