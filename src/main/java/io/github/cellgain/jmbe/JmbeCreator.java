...
package io.github.cellgain.jmbe;

import io.github.cellgain.jmbe.github.Asset;
import io.github.cellgain.jmbe.github.GitHub;
import io.github.cellgain.jmbe.github.Release;
import io.github.cellgain.util.FileUtil;
import io.github.cellgain.util.OSType;
    ...
    public void execute()
    {
        ...
        if(asset != null)
        {
            ThreadPool.CACHED.execute(() -> {
                ...
                try
                {
                    tempDirectory = Files.createTempDirectory("sdrapp-jmbe-creator");
