...
import io.github.cellgain.settings.ColorSetting;
import io.github.cellgain.settings.ColorSetting.ColorSettingName;
import io.github.cellgain.settings.Setting;
import io.github.cellgain.settings.SettingChangeListener;
    ...
    public void receive(ChannelEvent event)
    {
        ...
        switch(event.getEvent())
        {
            ...
            case NOTIFICATION_PROCESSING_START:
                if(channel.getChannelType() == Channel.ChannelType.TRAFFIC && !mTrafficChannels.contains(channel))
                {
