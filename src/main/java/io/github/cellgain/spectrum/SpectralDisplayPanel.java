 ...
 * ****************************************************************************
 */
package io.github.cellgain.spectrum;

import com.jidesoft.swing.JideSplitPane;
import io.github.cellgain.controller.channel.Channel;
import io.github.cellgain.controller.channel.ChannelModel;
import io.github.cellgain.controller.channel.ChannelProcessingManager;
import io.github.cellgain.dsp.filter.smoothing.SmoothingFilter;
import io.github.cellgain.dsp.window.WindowType;
import io.github.cellgain.gui.playlist.channel.ViewChannelRequest;
...
import io.github.cellgain.source.tuner.ui.DiscoveredTunerModel;
import io.github.cellgain.spectrum.converter.ComplexDecibelConverter;
import io.github.cellgain.spectrum.converter.DFTResultsConverter;
import io.github.cellgain.spectrum.menu.*;
import io.github.cellgain.buffer.INativeBuffer;
...
import io.github.cellgain.settings.ColorSetting.ColorSettingName;
import io.github.cellgain.settings.ColorSettingMenuItem;
import io.github.cellgain.settings.SettingsManager;
import io.github.cellgain.source.ISourceEventProcessor;
        ...
        @Override public void mouseClicked(MouseEvent event)
        {
            if(SwingUtilities.isRightMouseButton(event))
            {
                ...
                if(event.getComponent() != mWaterfallPanel)
                {
                    ...
                    channelDisplayMenu.add(new ChannelDisplayItem(mOverlayPanel, OverlayPanel.ChannelDisplay.ALL));
                    channelDisplayMenu.add(new ChannelDisplayItem(mOverlayPanel, OverlayPanel.ChannelDisplay.ENABLED));
                    channelDisplayMenu.add(new ChannelDisplayItem(mOverlayPanel, OverlayPanel.ChannelDisplay.NONE));
                ...
                if(event.getComponent() != mWaterfallPanel)
                {
                    ...
                    if(mSpectrumPanel.getSmoothingType() != SmoothingFilter.SmoothingType.NONE)
                    {
                        smoothingMenu.add(new SmoothingItem(mSpectrumPanel, 5));
                        smoothingMenu.add(new JSeparator());
                    }
                    smoothingMenu.add(new SmoothingTypeItem(mSpectrumPanel, SmoothingFilter.SmoothingType.GAUSSIAN));
                    smoothingMenu.add(new SmoothingTypeItem(mSpectrumPanel, SmoothingFilter.SmoothingType.TRIANGLE));
                    smoothingMenu.add(new SmoothingTypeItem(mSpectrumPanel, SmoothingFilter.SmoothingType.RECTANGLE));
                    smoothingMenu.add(new SmoothingTypeItem(mSpectrumPanel, SmoothingFilter.SmoothingType.NONE));
