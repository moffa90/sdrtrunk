 ...
 * ****************************************************************************
 */
package io.github.cellgain.source.tuner.hackrf;
...
public class HackRFTunerEditor extends TunerEditor<HackRFTuner,HackRFTunerConfiguration>
{
    ...
    private JComboBox getVgaGainCombo()
    {
        ...
        {
            mVgaGainCombo = new JComboBox<HackRFTunerController.HackRFVGAGain>(HackRFTunerController.HackRFVGAGain.values());
            ...
            mVgaGainCombo.addActionListener(arg0 ->
            {
                if(!isLoading())
                {
                    try
                    {
                        HackRFTunerController.HackRFVGAGain vgaGain = (HackRFTunerController.HackRFVGAGain) mVgaGainCombo.getSelectedItem();
    ...
    private JComboBox getLnaGainCombo()
    {
        ...
        {
            mLnaGainCombo = new JComboBox<HackRFTunerController.HackRFLNAGain>(HackRFTunerController.HackRFLNAGain.values());
            ...
            mLnaGainCombo.addActionListener(arg0 ->
            {
                if(!isLoading())
                {
                    try
                    {
                        HackRFTunerController.HackRFLNAGain lnaGain = (HackRFTunerController.HackRFLNAGain) mLnaGainCombo.getSelectedItem();
    ...
    private JComboBox getSampleRateCombo()
    {
        if(mSampleRateCombo == null)
        {
            ...
            mSampleRateCombo.addActionListener(e ->
            {
                if(!isLoading())
                {
                    HackRFTunerController.HackRFSampleRate sampleRate = (HackRFTunerController.HackRFSampleRate)getSampleRateCombo().getSelectedItem();
