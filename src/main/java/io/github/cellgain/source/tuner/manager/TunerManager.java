...
package io.github.cellgain.source.tuner.manager;

import io.github.cellgain.source.tuner.configuration.TunerConfiguration;
import io.github.cellgain.source.tuner.configuration.TunerConfigurationManager;
...
import io.github.cellgain.source.tuner.channel.ChannelSpecification;
import io.github.cellgain.source.tuner.channel.MultiFrequencyTunerChannelSource;
        ...
        public void start()
        {
            if(LibUsb.hasCapability(LibUsb.CAP_HAS_HOTPLUG))
            {
                ...
                int status = LibUsb.hotplugRegisterCallback(mLibUsbApplicationContext, events, flags, vendorId,
                        productId, deviceClass, this, "sdrapp hotplug support", mHotplugCallbackHandle);
