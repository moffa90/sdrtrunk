 ...
 * ****************************************************************************
 */
package io.github.cellgain.source.tuner.rtl.e4k;
...
import io.github.cellgain.source.tuner.rtl.RTL2832TunerController.SampleRate;
...
public class E4KTunerEditor extends TunerEditor<RTL2832Tuner, E4KTunerConfiguration>
{
    ...
    protected void tunerStatusUpdated()
    {
        ...
        if(hasTuner())
        {
            ...
            E4KEmbeddedTuner.E4KGain gain = getConfiguration().getMasterGain();
            getMasterGainCombo().setEnabled(true);
    ...
    private JComboBox getLNAGainCombo()
    {
        ...
        {
            mLNAGainCombo = new JComboBox<>(E4KEmbeddedTuner.E4KLNAGain.values());
            mLNAGainCombo.addActionListener(arg0 ->
            {
                if(!isLoading())
                {
                    try
                    {
                        E4KEmbeddedTuner.E4KLNAGain lnaGain = (E4KEmbeddedTuner.E4KLNAGain) mLNAGainCombo.getSelectedItem();
    ...
    private JComboBox getMixerGainCombo()
    {
        ...
        {
            mMixerGainCombo = new JComboBox<>(E4KEmbeddedTuner.E4KMixerGain.values());
            mMixerGainCombo.addActionListener(arg0 ->
            {
                if(!isLoading())
                {
                    try
                    {
                        E4KEmbeddedTuner.E4KMixerGain mixerGain = (E4KEmbeddedTuner.E4KMixerGain) mMixerGainCombo.getSelectedItem();
    ...
    private JComboBox getMasterGainCombo()
    {
        ...
        {
            mMasterGainCombo = new JComboBox<>(E4KEmbeddedTuner.E4KGain.values());
            ...
            mMasterGainCombo.addActionListener(arg0 ->
            {
                if(!isLoading())
                {
                    try
                    {
                        E4KEmbeddedTuner.E4KGain gain = (E4KEmbeddedTuner.E4KGain) mMasterGainCombo.getSelectedItem();
                        getEmbeddedTuner().setGain((E4KEmbeddedTuner.E4KGain) mMasterGainCombo.getSelectedItem(), true);
                        if(gain == E4KEmbeddedTuner.E4KGain.MANUAL)
                        {
    ...
    public void save()
    {
        if(hasConfiguration() && !isLoading())
        {
            ...
            config.setMasterGain((E4KEmbeddedTuner.E4KGain)getMasterGainCombo().getSelectedItem());
            config.setMixerGain((E4KEmbeddedTuner.E4KMixerGain)getMixerGainCombo().getSelectedItem());
            config.setLNAGain((E4KEmbeddedTuner.E4KLNAGain)getLNAGainCombo().getSelectedItem());
