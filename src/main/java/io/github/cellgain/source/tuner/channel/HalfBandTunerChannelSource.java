 ...
 * ****************************************************************************
 */
package io.github.cellgain.source.tuner.channel;
...
import io.github.cellgain.dsp.mixer.ComplexMixer;
import io.github.cellgain.dsp.mixer.ComplexMixerFactory;
...
public class HalfBandTunerChannelSource<T extends INativeBuffer> extends TunerChannelSource implements Listener<T>
{
                                      ...
                                      double sampleRate, ChannelSpecification channelSpecification) throws FilterDesignException
    {
        ...
        mBufferDispatcher = new Dispatcher(BUFFER_MAX_CAPACITY, "sdrapp heterodyne channel " +
