...
import io.github.cellgain.source.tuner.manager.ChannelSourceManager;
import io.github.cellgain.source.tuner.manager.HeterodyneChannelSourceManager;
import io.github.cellgain.source.tuner.manager.PolyphaseChannelSourceManager;
...
public abstract class Tuner implements ISourceEventProcessor, ITunerErrorListener
{
    ...
    public void stop()
    {
        ...
        {
            broadcast(new TunerEvent(this, TunerEvent.Event.NOTIFICATION_SHUTTING_DOWN));
    ...
    {
        broadcast(new TunerEvent(this, TunerEvent.Event.NOTIFICATION_ERROR_STATE));
    ...
    public void process(SourceEvent event)
    {
        switch(event.getEvent())
        {
            case NOTIFICATION_CHANNEL_COUNT_CHANGE:
                broadcast(new TunerEvent(Tuner.this, TunerEvent.Event.UPDATE_CHANNEL_COUNT));
                break;
            case NOTIFICATION_FREQUENCY_CHANGE:
                broadcast(new TunerEvent(Tuner.this, TunerEvent.Event.UPDATE_FREQUENCY));
                break;
            case NOTIFICATION_FREQUENCY_CORRECTION_CHANGE:
                broadcast(new TunerEvent(Tuner.this, TunerEvent.Event.UPDATE_FREQUENCY_ERROR));
                break;
            case NOTIFICATION_SAMPLE_RATE_CHANGE:
                broadcast(new TunerEvent(Tuner.this, TunerEvent.Event.UPDATE_SAMPLE_RATE));
                break;
            case NOTIFICATION_FREQUENCY_AND_SAMPLE_RATE_LOCKED:
            case NOTIFICATION_FREQUENCY_AND_SAMPLE_RATE_UNLOCKED:
                broadcast(new TunerEvent(Tuner.this, TunerEvent.Event.UPDATE_LOCK_STATE));
                break;
