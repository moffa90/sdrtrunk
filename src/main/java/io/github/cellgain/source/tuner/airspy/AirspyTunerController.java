...
package io.github.cellgain.source.tuner.airspy;
...
import io.github.cellgain.buffer.airspy.AirspyNativeBufferFactory;
...
import io.github.cellgain.source.tuner.usb.USBTunerController;
    ...
    public void setSampleRate(AirspySampleRate rate) throws LibUsbException, UsbException, SourceException
    {
        if(rate.getRate() != mSampleRate)
        {
            ...
            else
            {
                ...
                // Values below are from https://github.com/DSheirer/sdrapp/issues/815#issuecomment-699859590
                switch(mSampleRate)
                {
                    default:
                    case 10000000:
