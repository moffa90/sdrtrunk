 ...
 * ****************************************************************************
 */
package io.github.cellgain.source.tuner.ui;
...
import io.github.cellgain.source.tuner.manager.IDiscoveredTunerStatusListener;
import io.github.cellgain.source.tuner.manager.TunerManager;
import io.github.cellgain.source.tuner.manager.TunerStatus;
import io.github.cellgain.gui.control.JFrequencyControl;
...
import io.github.cellgain.util.SwingUtils;
        ...
        implements IDiscoveredTunerStatusListener, Listener<TunerEvent>
{
    ...
    protected JButton getEnabledButton()
    {
        if(mEnabledButton == null)
        {
            ...
            mEnabledButton.setToolTipText("Enable or disable the tuner for use by sdrapp");
