...
package io.github.cellgain.log;
...
public class ApplicationLog
{
    ...
    private static final String APPLICATION_LOG_FILENAME = "sdrapp_app.log";
    ...
    public void start()
    {
        ...
        if(mRollingFileAppender == null)
        {
            ...
            thresholdFilter.setName("sdrapp threshold filter");
...
//            StatusPrinter.print(loggerContext);
            ...
            if (atts != null) {
                mLog.info("SDRApp Version  : " + atts.getValue("Implementation-Version"));
            ...
            mLog.info("");
            mLog.info("*******************************************************************");
            mLog.info("**** sdrapp: a trunked radio and digital decoding application ***");
            mLog.info("****  website: https://github.com/dsheirer/sdrapp             ***");
            mLog.info("*******************************************************************");
        ...
        try {
            ...
            while (resources.hasMoreElements()) {
                try {
                    ...
                    Boolean hasTitle = atts.containsValue("sdrapp project");
                    if (hasTitle) {
                        return atts;
                    }
                } catch (IOException E) {
